...
select
  ...
  1,
  700,
  '{"type":"Polygon","coordinates":[[[59.99564,57.9183],[59.99376,57.92205],[59.98862,57.9248],[59.9816,57.9258],[59.97458,57.9248],[59.96944,57.92205],[59.96756,57.9183],[59.96944,57.91455],[59.97458,57.9118],[59.9816,57.9108],[59.98862,57.9118],[59.99376,57.91455],[59.99564,57.9183]]]}'::jsonb
where not exists (select 1 from public.delivery_zones where name = 'Зелёная зона');

update public.delivery_zones
set polygon_geojson = '{"type":"Polygon","coordinates":[[[59.99564,57.9183],[59.99376,57.92205],[59.98862,57.9248],[59.9816,57.9258],[59.97458,57.9248],[59.96944,57.92205],[59.96756,57.9183],[59.96944,57.91455],[59.97458,57.9118],[59.9816,57.9108],[59.98862,57.9118],[59.99376,57.91455],[59.99564,57.9183]]]}'::jsonb
where name = 'Зелёная зона';
